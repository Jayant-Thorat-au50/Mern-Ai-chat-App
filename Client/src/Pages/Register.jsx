    ...
    <div className=' w-full flex justify-center items-center h-[100vh]'>
       ...
       <form action=""   noValidate className='shadow-[0_0_10px_black] w-[25rem] bg-white  h-fit flex  flex-col gap-3 items-center'>
            ...
            <div className=' flex flex-col items-start w-full px-10 space-y-1'>
                ...
                <input name="email" value={userData.email} type="email" id='email' placeholder="Enter your email...." className='px-5 rounded text-black border-black py-2  border bg-[#F3F4F6] w-full' required/>
            </div>
            <div className=' flex flex-col items-start w-full px-10 relative space-y-1'>
                ...
                <input value={userData.password}  placeholder="Enter your password...."  id='password' className='border  px-5 py-2 text-black w-full border-black rounded bg-[#F3F4F6] borderbg-transparent' required name='password' />
               
            </div>

            <div className=' px-10  w-full flex justify-center items-center my-1'>
                <button type='submit' className=' bg-blue-400 w-full font-bold text-2xl py-1 rounded text-black hover:bg-blue-300'>register</button>
            </div>
            ...
            <div className='my-2'>
                <p className='text-lg text-black bg-transparent'>Do not have an acc? <span  className=' text-blue-600 font-semibold' >login</span></p>
            </div>
